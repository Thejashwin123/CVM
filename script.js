...
function getBotReply(message) {
  ...
  if (msg.includes("hi") || msg.includes("hello")) {
    ...
    return "Fees details: 1, location : 2, school timing : 3, contact : 4, principal name : 5, vice principal name : 6, about us : 7,  curriculum : 8,  results : 9, transport : 10,  library : 11, sports : 12, ";
  ...
  } else if (msg.includes("12")) {
    return "The school offers a variety of sports facilities, including a playground, basketball court, and indoor games area, promoting physical fitness and teamwork among students.";
  } 
